    ...
    <section id="education" className="py-24 px-6" ref={ref}>
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="space-y-5">
          <div className={`bg-[var(--card)] border border-[var(--border)] rounded-lg p-6 sm:p-8 transition-all duration-700 delay-200 hover:border-[var(--accent-glow)] hover:shadow-[0_0_24px_rgba(0,200,150,0.06)] ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="font-mono text-xs text-[var(--muted)]">Aug 2023 &ndash; May 2027</p>
          </div>
          <div className={`bg-[var(--card)] border border-[var(--border)] rounded-lg p-6 sm:p-8 transition-all duration-700 delay-300 hover:border-[var(--accent-glow)] hover:shadow-[0_0_24px_rgba(0,200,150,0.06)] ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="font-mono text-xs text-[var(--muted)]">2021 &nbsp;|&nbsp; 80%+</p>
          </div>
          <div className={`bg-[var(--card)] border border-[var(--border)] rounded-lg p-6 sm:p-8 transition-all duration-700 hover:border-[var(--accent-glow)] hover:shadow-[0_0_24px_rgba(0,200,150,0.06)] ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '400ms' }}>
            ...
            <p className="font-mono text-xs text-[var(--muted)]">2019</p>
          </div>
        </div>
      </div>
    </section>
