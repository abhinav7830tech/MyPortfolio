      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className={`relative pl-8 transition-all duration-700 delay-200 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="relative pb-0">
            ...
            <p className="text-sm text-[var(--muted)] mb-3">Data Analytics Intern</p>
            <ul className="list-none space-y-1.5">
                {[
                  ...
                  <li key={item} className="relative pl-5 text-sm text-[var(--muted)] leading-relaxed before:absolute before:left-0 before:top-[10px] before:w-1.5 before:h-1.5 before:rounded-full before:bg-[var(--accent-glow)]">
                    {item}
                  </li>
                ))}
            </ul>
