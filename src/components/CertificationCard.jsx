...
export default function CertificationCard({ title }) {
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-sm px-5 py-4 flex items-center gap-3 transition-all duration-300 hover:border-[var(--accent-glow)] hover:shadow-[0_0_16px_rgba(0,200,150,0.06)]">
